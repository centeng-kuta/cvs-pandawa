...
<div class="info">                                                                
	...
	<br />
	<p align="center">
		<a href="<?php echo ASSETS_BACKEND_DIR; ?>?q=MasterData/SpecialLeave/ListSpecialLeave.php&Link=1"><button class="btn" type="button">Done</button></a> &nbsp;
	</p>	
