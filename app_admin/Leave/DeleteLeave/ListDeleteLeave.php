                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortableLeaveApproval">
							...
							?>
                                <tr>
									...
									<td><a href="<?php echo ASSETS_BACKEND_DIR; ?>?q=Leave/LeaveApproval/AddLeaveApproval.php&id=<?php echo $LeaveAppr['p5_id']; ?>&Link=3">Process</a></td>
                                </tr>
                            <?php } ?>                                 
                            </tbody>
                        </table>
