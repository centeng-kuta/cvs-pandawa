...
?> 
 <form action="<?php echo form_action('Attendance/Reports/DailyReportForEmployee/ResultDailyReportForEmployee.php'); ?>" method="post"> 
     <div class="workplace">
            <div class="row-fluid">           
                <div class="span12">
                    <div class="head clearfix">
                        <div class="isw-documents"></div>
                        <h1>Daily Report For Employee Menu</h1>
                    </div>
            ...
            <p align="center">
				...
				<input class="btn" type="submit" name="DailyReportEmployee" value="Submit...">
				</p>
