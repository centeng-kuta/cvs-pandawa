...
include APP_BACKEND_DIR.'layouts'.DS.'header.php';
 ?> 
 <form action="<?php echo form_action('Attendance/Reports/MonthlyReportForDepartement/ResultMonthlyReportForDepartement.php&Link=3'); ?>" method="post"> 
     <div class="workplace">
            <div class="row-fluid">           
                <div class="span12">
                    <div class="head clearfix">
                        <div class="isw-documents"></div>
                        <h1>Monthly Report For Departement Menu</h1>
                    </div>
            ...
            <p align="center">
				<a href="<?php echo ASSETS_BACKEND_DIR; ?>?q=Attendance/Reports/MonthlyReportForDepartement/ListMonthlyReportForDepartement.php&Link=3"><button class="btn" type="button">Back...</button></a> &nbsp;
				<input class="btn" type="submit" name="MonthlyReportDepartement" value="Submit...">
				</p>
