...
<input type="hidden" value="<?php echo $LeaveCat['p5_leave']; ?>" name="LeaveName" />
     <div class="workplace">
            <div class="row-fluid">
                <div class="span12">
					...
					<div class="row-form clearfix">
						...
						<div class="span9"><input type="text" name="TotalDays" id="lama_cuti" value="<?php echo $sum_total; ?>" readonly="" /></div>
					</div> 
					
					<div class="row-form clearfix">
						<div class="span3">If-Hald-Day</div>
						<div class="span9"><input type="radio" name="LeaveCut" value="0" checked="checked" /> Full Day
											<input type="radio" name="LeaveCut" value="0.5" /> Morning
											<input type="radio" name="LeaveCut" value="0.6" /> Noon</div>
					</div> 
            ...
            <p align="center">
				<a href="<?php echo ASSETS_BACKEND_DIR; ?>?q=Leave/Leave/ListLeave.php&id=<?php echo $_GET['id']; ?>&Link=2"><button class="btn" type="button">Back...</button></a> &nbsp;
