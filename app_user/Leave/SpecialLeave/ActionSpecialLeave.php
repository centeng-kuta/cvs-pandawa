...
//END SEND SEND MAIL
			...
			header("Location:".ASSETS_BACKEND_DIR."?q=Leave/Leave/ListLeave.php&id=$_POST[LeaveId]&Link=2");
			} else if ($_GET['SpecialLeaveDel'] == "hapus") {
				mysql_query("UPDATE tbl_leave_trans SET p5_progress=3 WHERE p5_id='$_GET[id]'");
				header("Location:".ASSETS_BACKEND_DIR."?q=Leave/SpecialLeave/ListSpecialLeave.php&id=$_GET[LeaveId]&Link=2");
			}
?>