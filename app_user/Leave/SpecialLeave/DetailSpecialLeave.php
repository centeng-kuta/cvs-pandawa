...
$LeaveData = mysql_query("SELECT Lt.p5_id, Lt.p5_name, Lt.p5_date_request, Lt.p5_date_start, Lt.p5_date_end, Lt.p5_days, 
												  ...
												  INNER JOIN tbl_leave_master_sl AS Lm ON Lt.p5_sl_id = Lm.p5_id
...
<div class="info">                                                                
                                <ul class="rows">
                                    <li class="heading">Special Leave Info</li>
									
									<li>
                                        <div class="title">Leave Name</div>
                                        <div class="text">: Special Leave - <?php echo $p['p5_sl']; ?></div>
                                    </li>
...
<br />							
							<p align="center">
				<a href="<?php echo ASSETS_BACKEND_DIR; ?>?q=Leave/SpecialLeave/ListSpecialLeave.php&Link=2"><button class="btn" type="button">Back</button>   
				</p>
<?php
