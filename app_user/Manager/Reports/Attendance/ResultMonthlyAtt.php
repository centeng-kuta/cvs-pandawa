                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table">
                            <thead>
                                <tr>                          
									...
									<th width="3%">Emp.Name</th>
									<th width="3%">Job Title</th>
...
if ($JamKerjaMasuk != "" and $JamKerjaPulang != "" and $TransActIn['CheckIn'] == "" and $TransActOut['CheckOut'] == "" and $LeaveStatus == "") {
   ...
   ?>							
                                <tr>
									<td align="center"><?php echo $DtKary['p5_nip']; ?></td>
									<td align="center"><?php echo $DtKary['p5_nama']; ?></td>
									<td align="center"><?php echo $DtKary['p5_jabatan']; ?></td>
