$(document).ready(function(){
   ...
   // TOOLTIPS
        ...
        // WYSIWIG HTML EDITOR    
         ...
         {
            $("#tSortable").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null]});
		 ...
		 //SortTable Request Leave User
		 if($("#tSortableLeaveUser").length > 0)
         {
			$("#tSortableLeaveUser").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null, null]});
         }
		 
		 //SortTable Leave Approval
		 if($("#tSortableLeaveApproval").length > 0)
         {
			$("#tSortableLeaveApproval").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null, null, null, null, null, null, null, null]});
         }
		 
		 //SortTable Request Leave Admin
		 if($("#tSortableLeaveAdmin").length > 0)
         {
			$("#tSortableLeaveAdmin").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null, null, null]});
         }
		 
		 //SortTable EMPLOYEE DATA
		 if($("#tSortableEmployee").length > 0)
         {
			$("#tSortableEmployee").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null]});
         }
